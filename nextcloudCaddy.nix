...
in {
  ...
  options.services.nextcloudCaddy = {
    ...
    phpOptions = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        ```nix
        {
          services.nextcloudCaddy.phpOptions = lib.mkForce {
            /* ... */
          };
        }
        ```
    ...
    configureRedis = lib.mkOption {
      type = lib.types.bool;
      default = config.services.nextcloudCaddy.notify_push.enable;
      defaultText = literalExpression "config.services.nextcloudCaddy.notify_push.enable";
      description = lib.mdDoc ''
        ...
        options = {
          ...
          log_type = mkOption {
            ...
            description = lib.mdDoc ''
              ...
              systemd requires the php-systemd package to be added to services.nextcloudCaddy.phpExtraExtensions.
  ...
  config = mkIf cfg.enable (mkMerge [
    ...
    { systemd.timers.nextcloud-cron = {
      ...
      services.caddy.virtualHosts."srv.windowsfreak.de" = {
        extraConfig = ''
