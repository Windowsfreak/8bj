  ...
  mailserver = {
    ...
    loginAccounts = {
      ...
      "axel@parkour-deutschland.de" = {
        aliases = ["it@parkour-deutschland.de" "webmaster@parkour-deutschland.de" "aktivmitglieder@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/axel.parkour-deutschland.de.key";
      };
      "ben@parkour-deutschland.de" = {
        aliases = ["bildung@parkour-deutschland.de" "oeffentlichkeit@parkour-deutschland.de" "parkourparks@parkour-deutschland.de" "lizenzen@parkour-deutschland.de" "aktivmitglieder@parkour-deutschland.de"];
      ...
      "dirk@parkour-deutschland.de" = {
        aliases = ["wettkampf@parkour-deutschland.de" "oeffentlichkeit@parkour-deutschland.de" "parkourparks@parkour-deutschland.de" "aktivmitglieder@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/dirk.parkour-deutschland.de.key";
      };
      "dominik@parkour-deutschland.de" = {
        aliases = ["finanzen@parkour-deutschland.de" "wettkampf@parkour-deutschland.de" "parkourparks@parkour-deutschland.de" "lizenzen@parkour-deutschland.de"];
      ...
      "jennifer@parkour-deutschland.de" = {
        aliases = ["oeffentlichkeit@parkour-deutschland.de"];
      ...
      "lea@parkour-deutschland.de" = {
        aliases = ["parkourparks@parkour-deutschland.de" "lizenzen@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/lea.parkour-deutschland.de.key";
      };
      "lukas@parkour-deutschland.de" = {
        aliases = ["it@parkour-deutschland.de" "webmaster@parkour-deutschland.de" "satzung@parkour-deutschland.de" "design@parkour-deutschland.de" "aktivmitglieder@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/lukas.parkour-deutschland.de.key";
      };
      "maren@parkour-deutschland.de" = {
        aliases = ["info@parkour-deutschland.de" "it@parkour-deutschland.de" "webmaster@parkour-deutschland.de" "oeffentlichkeit@parkour-deutschland.de" "parkourparks@parkour-deutschland.de" "lizenzen@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/maren.parkour-deutschland.de.key";
      };
      "martin@parkour-deutschland.de" = {
        aliases = ["design@parkour-deutschland.de" "parkourparks@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/martin.parkour-deutschland.de.key";
      };
      "max@parkour-deutschland.de" = {
        aliases = ["lizenzen@parkour-deutschland.de" "satzung@parkour-deutschland.de" "wettkampf@parkour-deutschland.de" "aktivmitglieder@parkour-deutschland.de"];
        hashedPasswordFile = "/var/config/mail/max.parkour-deutschland.de.key";
      };
      "merlin@parkour-deutschland.de" = {
        aliases = ["info@parkour-deutschland.de" "it@parkour-deutschland.de" "webmaster@parkour-deutschland.de" "finanzen@parkour-deutschland.de"];
